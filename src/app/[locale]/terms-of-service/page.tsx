...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.bluelockskibidi.wiki'
  const path = '/terms-of-service'

  return {
    title: "Terms of Service - Blue Lock Skibidi Wiki",
    description: "Read the Terms of Service for Blue Lock Skibidi Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: "Blue Lock Skibidi Wiki",
      title: "Terms of Service - Blue Lock Skibidi Wiki",
      description: "Terms and conditions for using Blue Lock Skibidi Wiki.",
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1200,
          height: 630,
          alt: "Blue Lock Skibidi - Chaotic Anime Soccer on Roblox",
        },
      ],
    },
    twitter: {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Blue Lock Skibidi Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Blue Lock Skibidi Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Blue Lock Skibidi Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Blue Lock Skibidi Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Blue Lock: Skibidi". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Working codes and redemption steps</li>
              <li>Character and Style tier lists</li>
              <li>Controls, skills, and awakening guides</li>
              <li>Beginner tips and progression strategies</li>
              <li>Update notes and new character info</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Blue Lock Skibidi Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of Blue Lock: Skibidi. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Blue Lock Skibidi Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Blue Lock: Skibidi. We use such
            ...
            <ul>
              ...
              <li><strong>Demo Availability:</strong> Game availability and game updates may change without notice. We are not responsible for demo access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, BLUE LOCK SKIBIDI WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Blue Lock Skibidi Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@bluelockskibidi.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@bluelockskibidi.wiki</a>
            </p>
            <p>
